Packaging and Deploying pyInpolygon
...
2. Installing the pyInpolygon Package

A. Go to the directory that contains the file setup.py and the subdirectory pyInpolygon. 
...
3. Using the pyInpolygon Package

The pyInpolygon package is on your Python path. To import it into a Python script or 
   session, execute:
